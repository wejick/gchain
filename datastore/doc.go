...
2. Vectorstore
	Fully compatible with datastore interface with addition of SearchVector functionality. Vector search database
will prefer to use this interface.
3. Retrieval
	Provide simplified interface to get data from outside world, intended to interact in read only manner.

Datastore and Vectorstore will always compatible with Retrieval interface, make it easy to build application that needs external data.
